    ...
    >
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "radial-gradient(circle, rgba(236,0,155,0.15) 1.5px, transparent 1.5px)",
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(236,0,155,0.08) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
        ...
        {(["it", "en"] as const).map((l) => (
          <button
            ...
            style={{
              ...
              fontFamily: "'AvertaStd', system-ui, sans-serif",
              background:
                lang === l ? "#ec009b" : "rgba(255,255,255,0.08)",
              color: "#fff",
              border:
                lang === l
                  ? "none"
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.background = "#c4007f";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.background = "#ec009b";
              }}
              onMouseDown={(e) => {
